...
def _tools() -> list[dict]:
    return [
        ...
        {"name": "cerebrate_project_profile", "description": "【业务画像】数据世界+流程世界。action: read/list/draft/read_draft/promote/save/attach。", "inputSchema": {"type": "object", "properties": {"project": {"type": "string"}, "action": {"type": "string", "enum": ["read", "list", "draft", "read_draft", "promote", "save", "attach"], "default": "read"}, "level": {"type": "string", "enum": ["summary", "graph", "detail"], "default": "detail"}, "llm_refine": {"type": "boolean", "default": False}, "use_harvest": {"type": "boolean", "default": False}, "branch": {"type": "string", "default": ""}, "limit": {"type": "integer", "default": 200}, "profile": {"type": "object"}, "node_path": {"type": "string", "default": ""}, "memory_id": {"type": "string", "default": ""}}, "required": ["project"]}},
